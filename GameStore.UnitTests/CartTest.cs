...
namespace GameStore.UnitTests {
    ...
    public class CartTests {
        ...
        /// </summary>
        [TestMethod]
        public void Add_To_Cart_And_Go_Screen () {
            // Организация - создание имитированного хранилища
            Mock<IGameRepository> mock = new Mock<IGameRepository>();
            mock.Setup( m => m.Games ).Returns( new List<Game> {
                new Game {GameId = 1, Name = "Игра1", Category = "Кат1"},
        ...
        // Проверяем URL
        [TestMethod]
        public void Try_View_Cart_Contents () {
            // Организация - создание корзины
            Cart cart = new Cart();
        ...
        [TestMethod]
        public void Do_No_Checkout_Empty_Cart () {
        ...
        [TestMethod]
        public void Do_Not_Checkout_Bad_ShippingDetails () {
            // Организация - создание имитированного обработчика заказов
            Mock<IOrderProcessor> mock = new Mock<IOrderProcessor>();
        ...
        [TestMethod]
        public void Try_Checkout_And_Submit_Order () {
            // Организация - создание имитированного обработчика заказов
            Mock<IOrderProcessor> mock = new Mock<IOrderProcessor>();
